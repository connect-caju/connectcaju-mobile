...
const validateUserData = (
  ...
  if (
    !(
      retrievedPassword.includes(retrievedPasswordConfirm) &&
      retrievedPasswordConfirm.includes(retrievedPassword)
    )
  ) {
    setErrors({
      ...errors,
